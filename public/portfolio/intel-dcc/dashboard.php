      ...
      <nav id="site-header-nav" class="site-header__nav">
        <ul class="site-header__nav__list">
          <li class="site-header__nav__item">
            <a href="dashboard.php" class="site-header__nav__link  site-header__nav__link--active ">Map View</a>
          </li>
          <li class="site-header__nav__item">
...
<section class="google-map">
  ...
  <div id="google-map-placeholder" class="google-map" style="padding-top: 0"></div>
  <div id="intel-api-loading-icon" class="loading-icon loading-icon--corner"></div>

</section>

<section class="main-section main-section--mobile">
  <div class="main-section__container">

    <h1 class="main-section__heading">Dashboard</h1>

    <section class="device-list">

      <div class="device-list__sort">
        <div class="device-list__sort__item">
          <input id="sort-device-list-by-distance" type="button" class="device-list__sort__button device-list__sort__button--nearest" value="Nearest">
        </div>
        <div class="device-list__sort__item">
          <input id="sort-device-list-by-urgency" type="button" class="device-list__sort__button device-list__sort__button--urgent" value="Urgent">
        </div>
        <div class="device-list__sort__item">
          <input id="sort-device-list-by-time" type="button" class="device-list__sort__button device-list__sort__button--recent" value="Recent">
        </div>
      </div>

      <div id="device-list-items" class="device-list__items accordion" data-accordion>
...
<script src="//maps.googleapis.com/maps/api/js?key=AIzaSyDaQjmtzmmhuGRZFQdqm8mKqZzpf7vYZpI"></script>
