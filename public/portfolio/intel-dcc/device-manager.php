    ...
    <div class="site-header__item site-header__item--nav">
      ...
      <nav id="site-header-nav" class="site-header__nav">
        <ul class="site-header__nav__list">
          ...
          <li class="site-header__nav__item">
            <a href="device-manager.php" class="site-header__nav__link  site-header__nav__link--active ">Manage Devices</a>
          </li>
          <li class="site-header__nav__item">
...
<section class="main-section">
  <div class="main-section__container">
    ...
    <h1 class="main-section__heading">Manage Devices</h1>

    <div class="page-content">

      <div id="page-notification" class="page-notification">
        <div class="page-notification__message page-notification__message--success">Settings Updated</div>
      </div>
  ...
  <div class="inline-dropdowns__row">
    ...
    <div class="inline-dropdowns__section">
      ...
      <h3 class="page-content__heading">Thresholds</h3>

      <div class="inline-dropdowns">
        <div class="inline-dropdowns__row">
          <div class="inline-dropdowns__section">
            <div class="standard-input-wrapper standard-input-wrapper--large">

              <div class="inline-fields">
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-value-01">
                      Low <span data-threshold-value-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-value-01" class="standard-input standard-input--full-width" type="text" data-threshold-value="1">
                  </div>
                </div>
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-duration-01">
                      Duration <span data-threshold-duration-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-duration-01" class="standard-input standard-input--full-width standard-input--disabled" type="text" data-threshold-duration="1" value="0" disabled>
                  </div>
                </div>
              </div>
          ...
          <div class="inline-dropdowns__section">
            <div class="standard-input-wrapper standard-input-wrapper--large">
              ...
              <div class="inline-fields">
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-value-02">
                      Medium <span data-threshold-value-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-value-02" class="standard-input standard-input--full-width" type="text" data-threshold-value="2">
                  </div>
                </div>
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-duration-02">
                      Duration <span data-threshold-duration-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-duration-02" class="standard-input standard-input--full-width standard-input--disabled" type="text" data-threshold-duration="2" value="0" disabled>
                  </div>
                </div>
              </div>
          ...
          <div class="inline-dropdowns__section">
            <div class="standard-input-wrapper standard-input-wrapper--large">
              ...
              <div class="inline-fields">
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-value-03">
                      High <span data-threshold-value-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-value-03" class="standard-input standard-input--full-width" type="text" data-threshold-value="3">
                  </div>
                </div>
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-duration-03">
                      Duration <span data-threshold-duration-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-duration-03" class="standard-input standard-input--full-width standard-input--disabled" type="text" data-threshold-duration="3" value="0" disabled>
                  </div>
                </div>
              </div>
          ...
          <div class="inline-dropdowns__section">
            <div class="standard-input-wrapper standard-input-wrapper--large">
              ...
              <div class="inline-fields">
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-value-04">
                      Very High <span data-threshold-value-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-value-04" class="standard-input standard-input--full-width" type="text" data-threshold-value="4">
                  </div>
                </div>
                <div class="inline-fields__row">
                  <div class="inline-fields__left">
                    <label for="threshold-duration-04">
                      Duration <span data-threshold-duration-unit></span> :
                    </label>
                  </div>
                  <div class="inline-fields__right">
                    <input id="threshold-duration-04" class="standard-input standard-input--full-width standard-input--disabled" type="text" data-threshold-duration="4" value="0" disabled>
                  </div>
                </div>
              </div>
      ...
      <h3 class="page-content__heading">Calibration Offset</h3>
      ...
      <div class="inline-dropdowns">
        <div class="inline-dropdowns__row">
          <div class="inline-dropdowns__section">
            ...
            <div class="standard-input-wrapper">
              <input id="calibration-offset" class="standard-input standard-input--full-width" type="text" value="0">
            </div>
      ...
      <div class="page-content__footer">
        ...
        <input id="device-manager-alert-type" type="hidden" value="Threshold">
        <input id="device-manager-save" class="standard-button standard-button--no-margin" type="submit" value="Save">
...
<script src="js/device-manager.min.js"></script>
