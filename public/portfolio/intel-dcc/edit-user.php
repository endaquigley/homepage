...
<section class="main-section">
  <div class="main-section__container">
    ...
    <h1 id="main-section-heading" class="main-section__heading">Edit User</h1>
    ...
    <div class="page-content">
      ...
      <div id="page-notification" class="page-notification">
        <div class="page-notification__message page-notification__message--success">User Updated</div>
      </div>

      <h3 class="page-content__heading">Details</h3>

      <div id="user-settings" class="inline-fields">
        <div class="inline-fields__row">
          <div class="inline-fields__left">
            <label for="user-username">Username:</label>
          </div>
          <div class="inline-fields__right">
            <input id="user-username" class="standard-input" type="text">
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
          ...
          <div class="inline-fields__right">
            <input id="user-firstname" class="standard-input" type="text">
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
          ...
          <div class="inline-fields__right">
            <input id="user-lastname" class="standard-input" type="text">
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
          ...
          <div class="inline-fields__right">
            <input id="user-email" class="standard-input" type="text">
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
          ...
          <div class="inline-fields__right">
            <input id="user-password" class="standard-input" type="password" placeholder="optional">
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
          ...
          <div class="inline-fields__right">
            <input id="user-mobile" class="standard-input" type="text" placeholder="optional">
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
          ...
          <div class="inline-fields__right">
            <select id="user-role" class="standard-input standard-input--select standard-input--border">
              <option value="User">User</option>
              <option value="UserAdmin">Admin User</option>
              <option value="UserAdminSuper">Super User</option>
            </select>
          </div>
        </div>
        <div class="inline-fields__row">
          <div class="inline-fields__left">
            <label for="user-comm-prefs">Communication:</label>
          </div>
          <div class="inline-fields__right">
            <select id="user-comm-prefs" class="standard-input standard-input--select standard-input--border">
              <option></option>
              <option value="EmailOnly">Email Only</option>
              <option value="EmailOffice">Email + Office hour txts</option>
              <option value="EmailDay">Email + non-night txts</option>
              <option value="EmailAny">Email + anytime txts</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="page-content__footer">
        <input id="save-user-button" type="button" class="standard-button standard-button--no-margin" value="Save">
      </div>
...
<script src="js/user-manager.min.js"></script>
