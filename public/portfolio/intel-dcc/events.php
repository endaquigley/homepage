...
<section class="main-section">
  <div class="main-section__container">
    ...
    <h1 class="main-section__heading">Manage Notifications</h1>

    <div class="page-content">

      <div id="page-notification" class="page-notification">
        <div class="page-notification__message page-notification__message--error">Event Deleted</div>
      </div>

      <div id="event-list" class="standard-list">
        <div class="standard-list__item standard-list__item--teal">Event Name</div>

        <!-- populate list of events from Intel API -->

      </div>

      <div class="page-content__footer">
        <a href="new-event.php" class="standard-button standard-button--no-margin">New Event</a>
      </div>
