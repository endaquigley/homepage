<?php
  ...
  require(dirname( __FILE__ ) . '/api/intel.php');
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $response = $intel->authenticateUser($username, $password);

    if (property_exists($response, 'userId')) {
...
<section class="main-section">
  <div class="main-section__container">
    ...
    <h1 class="main-section__heading">Login</h1>

    <div class="page-content">

        <?php if ($loginFailed): ?>

          <div id="page-notification" class="page-notification page-notification--show">
            <div class="page-notification__message page-notification__message--error">Incorrect username / password</div>
          </div>
        ...
        <form action="login.php" method="POST">
          ...
          <div class="inline-dropdowns">
            <div class="inline-dropdowns__row">
              <div class="inline-dropdowns__section">
                ...
                <h3 class="inline-dropdowns__heading">Username</h3>
                <div class="standard-input-wrapper">
                  <input name="username" class="standard-input standard-input--full-width" type="text" value="">
                </div>
              ...
              <div class="inline-dropdowns__section">
                ...
                <h3 class="inline-dropdowns__heading">Password</h3>
                <div class="standard-input-wrapper">
                  <input name="password" class="standard-input standard-input--full-width" type="password" value="">
                </div>
          ...
          <div class="page-content__footer">
            <input id="submit-button" class="standard-button standard-button--no-margin" type="submit" value="Login">
          </div>
...
<script type="text/javascript">
  ...
  setTimeout(function() {
    ...
    notification.removeClass('page-notification--show');
  }, 4000);
